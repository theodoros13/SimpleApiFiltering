...
namespace Zavos\WebApiLogger\Console\Command;

use Magento\Framework\Exception\LocalizedException;
use Magento\Framework\App\ObjectManager;
use Zavos\WebApiLogger\Cron\CleanUp;
...
class WebApiLog extends Command {
	...
	protected function configure () {
		parent::configure();
		$this->setName( "zavos:web:logger" )
		     ->setDescription( "Zavos Web Api Logger Commands" );
